...
public class GraphicOverlay extends View {
    ...
    public void setCameraInfo(int previewWidth, int previewHeight, int facing) {
        synchronized (mLock) {
            ...
            Shared.gPreviewWidth = previewWidth;
            Shared.gPreviewHeight = previewHeight;
            Shared.gPreviewDataInt = new int[mPreviewWidth * mPreviewHeight];
        }
        postInvalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        synchronized (mLock) {
            ...
            //Log.i("DBG", "GraphicOverlay: onDraw()");
        }
    }
}
